...
json_data = 'test_data/accessinfo.json'
...
class TestLoginDDT(unittest.TestCase):
    ...
    def should_login_fail_with_erro_msg(self, erro_msg):
    ...
    @file_data(json_data)
    def test_02_login_fail(self, username, password, erro_msg):
        self.login_with_username_password(username, password)
        self.should_login_fail_with_erro_msg(erro_msg)
